...
export default function ChannelPerformanceChart({ totalConversions }: ChannelPerformanceChartProps) {
  ...
  const data: ChannelData[] = [
    { name: 'WhatsApp', value: Math.round(totalConversions * 0.40), conversionRate: 8.3, color: '#8F85FF' },
    { name: 'LinkedIn', value: Math.round(totalConversions * 0.30), conversionRate: 6.1, color: '#CFC7FF' },
    { name: 'Web',      value: Math.round(totalConversions * 0.20), conversionRate: 5.2, color: '#635BFF' },
        ...
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            ...
            <Tooltip 
              ...
              itemStyle={{ color: '#161A24', fontWeight: 600, fontSize: '12px' }}
            />
          </PieChart>
        </ResponsiveContainer>
      </div>
