...
-- Nota: sustituye a la 149, que apunto a un correo que no es el de la cuenta
--       de LeadSeed y por tanto no cargo nada.
...
--     and user_id = (select id from auth.users where email = 'planespro.cl@gmail.com');
