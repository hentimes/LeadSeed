-- Query permanente
-- Dominio: saas
-- Objetivo: alinear RPC de funcionalidades activas con los feature_id canonicos
...
BEGIN
  ...
  SELECT array_agg(DISTINCT f.id) INTO v_features
...
'Retorna los feature_id activos del usuario actual, combinando plan y overrides.';
