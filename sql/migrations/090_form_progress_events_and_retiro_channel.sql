-- form_progress_events_and_retiro_channel
--
-- Espejo de trazabilidad: esta migracion se creo y se aplico a produccion
-- directamente en supabase/migrations/20260805000600_form_progress_events_and_retiro_channel.sql
...
-- busqueda secuencial en sql/migrations/ no se corte en 089. No requiere
-- aplicarse de nuevo: la version real ya esta corriendo en Supabase bajo el
-- timestamp 20260805000600.
--
